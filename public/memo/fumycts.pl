...
# ================================================================== #
#  Fumy Versatile Control Set Ver 2.15.0 (UTF-8)        [fumycts.pl] #
# ================================================================== #
	...
	$makeCatTreeStructure = sub {
		...
		for my $i ( 0 .. $#catdata ) {
			...
			if( lc($checkParentCatId) eq lc($parentcat) ) {
				...
				my $catPartD = '<span class="catdescription">' . &forsafety($catdscrpt) . '</span>';
...
sub getCategoryTable
{
	...
	push( @ret, '<table class="catlist standard"><tr><th>カテゴリID</th><th>カテゴリ名</th><th style="font-size:0.5em;">アイコン</th><th>概要文</th><th>親カテゴリID</th><th>該当個数</th><th>掲載順序</th></tr>' );
